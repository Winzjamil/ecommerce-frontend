...
function Sidebar() {
  ...
  return (
    <aside className="w-full    h-screen text-white border-r  border-r-white flex-col bg-stone-600 p-2 ">
      <div className="flex relative left-[55%] w-full items-center text-xs max-w-25 gap-1 p-1  bg-gray-700 rounded ">
        {LoginUser.profile ? (
